...
export default function LoginPage() {
  ...
  if (session.user)
    return (
      <Navigate
        replace
        to={typeof from === 'string' && from.startsWith('/companies') ? from : '/companies'}
      />
    )
  ...
  return (
    <Box sx={{ minHeight: '100dvh', display: 'grid', placeItems: 'center', p: 2 }}>
      <Paper variant="outlined" sx={{ p: { xs: 3, sm: 5 }, width: '100%', maxWidth: 440 }}>
        ...
        <Typography variant="h4" component="h1" sx={{ mt: 1, mb: 1 }}>
          Welcome back
        </Typography>
        ...
        >
          ...
          />
          <Button type="submit" variant="contained" loading={mutation.isPending} size="large">
            Sign in
          </Button>
        </Stack>
      </Paper>
